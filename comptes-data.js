...
const comptesData = {
  ...
  "102": {
    ...
    nature: "Compte de bilan (Passif)",
    sens: "Créditeur",
    contenu: "Représente la contrepartie de l'intégration au patrimoine des entreprises publiques des immobilisations et fonds affectés sur décision de l'Autorité publique. Cette dotation peut aussi se réaliser par transformation de dettes.",
    subdivisions: {
  ...
  "103": {
    ...
    contenu: "À la création d'une entreprise individuelle, le capital initial représente le montant des apports en nature ou en espèces effectués par l'entrepreneur à titre définitif et des dettes qu'il décide d'inscrire au bilan. Ce capital est modifié par les apports, les retraits et l'affectation des résultats.",
    fonctionnement: {
      credit: [
  ...
  "104": {
    ...
    contenu: "Sert à établir la situation de l'entrepreneur individuel concernant : les apports et compléments d'apports effectués à titre temporaire (versements en caisse, paiement de dépenses de l'entreprise sur fonds privés) et les retraits effectués pour son usage personnel ou familial (prélèvements en nature, retraits de fonds).",
    subdivisions: {
  ...
  "105": {
    ...
    nature: "Compte de bilan (Passif)",
    sens: "Créditeur",
    contenu: "La prime représente un droit d'entrée demandé au nouvel actionnaire lorsque l'action vaut, avant augmentation de capital, beaucoup plus que sa valeur nominale. Elle représente une partie des apports purs et simples non comprise dans le capital social. Les primes figurent distinctement au passif du bilan.",
    subdivisions: {
  ...
  "106": {
    ...
    nature: "Compte de bilan (Passif)",
    sens: "Créditeur",
    contenu: "L'écart de réévaluation représente la contrepartie au passif des augmentations de valeur d'éléments actifs, soit dans le cadre d'une réévaluation légale (1061), soit dans celui d'une réévaluation libre (1062). Il s'inscrit distinctement au passif dans les capitaux propres.",
    subdivisions: {
  ...
  "109": {
    ...
    sens: "Débiteur",
    contenu: "Retrace la créance de la société sur les actionnaires pour la fraction du capital non encore appelé par les organes compétents. Il figure en deuxième ligne au passif du bilan, en moins parmi les capitaux propres.",
    fonctionnement: {
      debit: [
  ...
  "11": {
    ...
    nature: "Compte de bilan (Passif)",
    sens: "Créditeur",
    contenu: "Les réserves correspondent à des bénéfices laissés à la disposition de l'entreprise et non incorporés au capital. L'obligation de constituer des réserves résulte des dispositions statutaires ou réglementaires et des décisions des organes compétents.",
    subdivisions: {
      "111":  "Réserve légale",
  ...
  "12": {
    ...
    contenu: "Correspond au montant soit des bénéfices d'exercices antérieurs dont l'affectation a été reportée, soit des pertes non compensées par des prélèvements opérés sur les bénéfices, les réserves ou le capital. Il est inscrit au passif sur une ligne distincte : en moins si son solde est débiteur.",
    subdivisions: {
  ...
  "13": {
    ...
    contenu: "Le résultat net de l'exercice peut être défini comme : (1) la différence entre les produits et les charges de la période ; ou (2) la variation des capitaux propres entre le début et la clôture, hors apports/retraits et hors réévaluation. Quel que soit son signe, il est inscrit au passif du bilan parmi les capitaux propres.",
    subdivisions: {
  ...
  "14": {
    ...
    nature: "Compte de bilan (Passif)",
    sens: "Créditeur",
    contenu: "Les subventions d'investissement sont des aides financières non remboursables accordées aux entreprises pour l'acquisition ou la création de valeurs immobilisées (subventions d'équipement) ou le financement d'activités à long terme. Elles peuvent aussi consister en l'octroi de biens et services. Elles figurent pour leur montant net au passif du bilan parmi les capitaux propres jusqu'à ce qu'elles aient rempli leur objet.",
    subdivisions: {
  ...
  "15": {
    ...
    nature: "Compte de bilan (Passif)",
    sens: "Créditeur",
    contenu: "Les provisions réglementées sont des provisions à caractère purement fiscal ou réglementaire, comptabilisées non pas en application de principes comptables, mais suivant des dispositions légales et réglementaires (lois de finances notamment). Peuvent y être classés : les amortissements dérogatoires, les plus-values de cession à réinvestir, les provisions pour hausse de prix, pour investissement, pour reconstitution de gisements.",
    subdivisions: {
  ...
  "16": {
    ...
    nature: "Compte de bilan (Passif)",
    sens: "Créditeur",
    contenu: "Les emprunts et dettes assimilées sont des ressources financières externes contractées auprès d'établissements de crédit et/ou de tiers divers, affectées de façon durable au financement des moyens d'exploitation ou de production. Remboursables à terme, ils participent avec les capitaux propres à la couverture des besoins durables de l'entreprise.",
    subdivisions: {
  ...
  "17": {
    ...
    nature: "Compte de bilan (Passif)",
    sens: "Créditeur",
    contenu: "Enregistre le montant correspondant à la valeur d'entrée des biens acquis par contrats de crédit-bail et assimilés d'importance significative ou de locations renouvelables sans limitation. Cette valeur est celle figurant dans le contrat ou la somme actualisée des redevances de crédit-bail.",
    subdivisions: {
  ...
  "18": {
    ...
    nature: "Compte de bilan (Passif)",
    sens: "Créditeur",
    contenu: "Les dettes liées à des participations sont des emprunts contractés auprès d'entreprises liées ou avec lesquelles l'entreprise a un lien de participation. Les comptes de liaison sont des comptes ouverts entre le siège et les établissements ou succursales disposant d'une comptabilité autonome.",
    subdivisions: {
  ...
  "19": {
    ...
    sens: "Créditeur",
    contenu: "Les provisions financières pour risques et charges couvrent des charges, des risques et pertes nettement précisés quant à leur objet, que des événements survenus ou en cours rendent probables, mais comportant un élément d'incertitude quant à leur montant ou réalisation prévisible à plus d'un an. Elles sont inscrites au passif du bilan dans les dettes financières et ressources assimilées.",
    subdivisions: {
  ...
  "20": {
    ...
    sens: "Débiteur",
    contenu: "Les charges immobilisées sont des charges à caractère général, non répétitives, ayant une incidence sur le résultat de l'entreprise et pouvant engendrer des économies ou des gains sur les exercices ultérieurs. Elles constituent des actifs fictifs et comprennent : les frais d'établissement, les charges à répartir sur plusieurs exercices, et les primes de remboursement des obligations.",
    subdivisions: {
  ...
  "21": {
    ...
    sens: "Débiteur",
    contenu: "Les immobilisations incorporelles sont des immobilisations immatérielles et tous les autres éléments susceptibles de générer des avantages futurs. Elles ont la nature de biens acquis ou créés par l'entreprise, non pour être vendus ou transformés, mais pour être utilisés de manière durable pour la réalisation des opérations professionnelles.",
    subdivisions: {
  ...
  "23": {
    ...
    nature: "Compte de bilan (Actif)",
    sens: "Débiteur",
    contenu: "Ce compte enregistre le montant des opérations ayant trait aux apports, à l'acquisition et à la création par l'entreprise de bâtiments, installations et agencements, de même que leur cession, disparition et mise au rebut.",
    subdivisions: {
  ...
  "24": {
    ...
    nature: "Compte de bilan (Actif)",
    sens: "Débiteur",
    contenu: "Le matériel (machines, mobiliers) est constitué par l'ensemble des objets et instruments avec (et ou par) lesquels sont extraits, transformés ou façonnés les matières ou fournitures, ou sont fournis les services qui sont l'objet même de la profession exercée.",
    subdivisions: {
  ...
  "27": {
    ...
    nature: "Compte de bilan (Actif)",
    sens: "Débiteur",
    contenu: "Les autres immobilisations financières comprennent : les titres autres que les titres de participation que l'entreprise n'a ni l'intention ni la possibilité de revendre dans un bref délai ; les prêts nés en vertu de dispositions contractuelles ; les créances non commerciales assimilées à des prêts (dépôts et cautionnements).",
    subdivisions: {
  ...
  "29": {
    ...
    nature: "Compte de bilan (Actif — valeur négative en déduction des immobilisations brutes)",
    sens: "Créditeur",
    contenu: "La provision pour dépréciation constate l'amoindrissement probable de la valeur d'un élément d'actif résultant de causes dont les effets ne sont pas jugés irréversibles. À la différence des amortissements, les provisions pour dépréciation sont réversibles. Elles sont inscrites distinctement à l'actif, en diminution de la valeur brute des biens pour donner leur valeur comptable nette (V.C.N.).",
    subdivisions: {
  ...
  "33": {
    ...
    nature: "Compte de bilan (Actif circulant)",
    sens: "Débiteur",
    contenu: "Les autres approvisionnements sont des matières et fournitures acquises par l'entreprise qui concourent à la fabrication ou à l'exploitation, sans entrer dans la composition des produits fabriqués ou traités.",
    subdivisions: {
  ...
  "37": {
    ...
    nature: "Compte de bilan (Actif circulant)",
    sens: "Débiteur",
    contenu: "Les produits intermédiaires sont des produits ayant atteint un stade déterminé de fabrication et disponibles pour des fabrications ultérieures. Les produits résiduels comprennent les déchets, rebuts et matières de récupération.",
    subdivisions: {
  ...
  "38": {
    ...
    sens: "Débiteur",
    contenu: "Marchandises, matières, fournitures ou produits fabriqués expédiés par le fournisseur et non encore réceptionnés par l'entreprise, ou détenus chez des tiers mais dont l'entreprise est propriétaire.",
    subdivisions: {
  ...
  "39": {
    ...
    sens: "Créditeur",
    contenu: "Dépréciations subies par des stocks de marchandises, matières et autres approvisionnements résultant de causes diverses dont les effets ne sont pas jugés irréversibles.",
    subdivisions: {
  ...
  "42": {
    ...
    sens: "Créditeur (en général)",
    contenu: "Le compte Personnel enregistre l'ensemble des opérations entre l'entreprise et les personnes liées par un contrat de travail, ainsi que les représentants du personnel. Il comprend le personnel de direction et d'encadrement, les employés, ouvriers, occasionnels, représentants salariés, associés et dirigeants exerçant des fonctions techniques, et les membres de la famille de l'exploitant salariés.",
    subdivisions: {
  ...
  "43": {
    ...
    sens: "Créditeur",
    contenu: "Ce compte enregistre le montant des cotisations sociales salariales et patronales dues aux organismes sociaux et les règlements de cotisations effectués à leur profit.",
    subdivisions: {
  ...
  "44": {
    ...
    contenu: "Les opérations à inscrire à ce compte concernent les opérations faites avec l'État et les diverses collectivités publiques en tant que pouvoirs publics (impôts, taxes, TVA, subventions, dotations).",
    subdivisions: {
  ...
  "45": {
    ...
    nature: "Compte de bilan (Actif ou Passif selon solde)",
    sens: "Débiteur ou Créditeur",
    contenu: "Ce compte enregistre les dettes et créances envers les organismes internationaux, autres que celles liées à l'activité ordinaire de l'entreprise : dépenses à assumer, dettes des organismes vis-à-vis de l'entreprise, et règlement de subventions ou dotations.",
    subdivisions: {
  ...
  "46": {
    ...
    nature: "Compte de bilan (Actif ou Passif selon solde)",
    sens: "Débiteur ou Créditeur",
    contenu: "Le compte 46 enregistre les créances/dettes envers les associés résultant des mouvements du capital social, et les créances/dettes temporaires en comptes courants, pour les associés ordinaires et les autres sociétés du groupe.",
    subdivisions: {
  ...
  "47": {
    ...
    nature: "Compte de bilan (Actif ou Passif selon solde)",
    sens: "Débiteur ou Créditeur",
    contenu: "Ce compte enregistre les opérations en instance de régularisation : créances et dettes liées à l'acquisition de titres, charges constatées d'avance, produits constatés d'avance, écarts de conversion sur opérations en devises, et créances sur travaux non encore facturables.",
    subdivisions: {
  ...
  "48": {
    ...
    nature: "Compte de bilan (Actif ou Passif selon solde)",
    sens: "Débiteur ou Créditeur",
    contenu: "Créances et dettes consécutives à des opérations effectuées par l'entreprise mais n'ayant pas de lien direct avec l'activité ordinaire de l'entreprise.",
    subdivisions: {
  ...
  "49": {
    ...
    sens: "Créditeur",
    contenu: "Dépréciations subies par des comptes de tiers résultant de causes diverses dont les effets ne sont pas jugés irréversibles, et provisions pour risques à court terme.",
    subdivisions: {
  ...
  "50": {
    ...
    sens: "Débiteur",
    contenu: "Titres cessibles acquis en vue d'en retirer un revenu direct ou une plus-value à brève échéance.",
    subdivisions: {
  ...
  "51": {
    ...
    nature: "Compte de bilan (Actif — trésorerie)",
    sens: "Débiteur",
    contenu: "Les valeurs à encaisser sont les effets, chèques et autres valeurs transmis à la banque dont l'entreprise attend l'encaissement à l'échéance.",
    subdivisions: {
  ...
  "52": {
    ...
    contenu: "Ce compte enregistre les opérations financières effectuées entre l'entreprise, les banques agréées dans un État-partie et les autres banques.",
    subdivisions: {
      "521":  "Banques locales",
      "5211": "Banque X",
      "5212": "Banque Y",
  ...
  "53": {
    ...
    nature: "Compte de bilan (Actif — ou Passif si découvert)",
    sens: "Débiteur (créditeur si découvert)",
    contenu: "Ce compte enregistre les opérations entre l'entreprise et les Chèques postaux, le Trésor dans un État de la Région, et les autres établissements financiers.",
    subdivisions: {
      "531": "Chèques postaux",
      "532": "Trésor",
  ...
  "54": {
    ...
    nature: "Compte de bilan (Actif — trésorerie)",
    sens: "Débiteur",
    contenu: "Les instruments de trésorerie appartiennent à la catégorie des instruments financiers. Ils comprennent les options de taux, les options de change, les options sur actions et les instruments de trésorerie à terme.",
    subdivisions: {
  ...
  "56": {
    ...
    sens: "Créditeur",
    contenu: "Ce compte enregistre le montant des crédits de trésorerie inscrits au compte courant bancaire et le montant nominal des effets escomptés.",
    subdivisions: {
  ...
  "57": {
    ...
    contenu: "Le compte Caisse retrace les opérations d'encaissement et de paiement effectuées en espèces pour les besoins de l'entreprise.",
    subdivisions: {
  ...
  "59": {
    ...
    sens: "Créditeur",
    contenu: "Ce compte enregistre l'amoindrissement de la valeur des titres, valeurs liquides et avoirs en banque résultant de causes précises mais dont les effets ne sont pas jugés irréversibles, ainsi que les provisions de caractère financier pour risques à moins d'un an.",
    subdivisions: {
  ...
  "603": {
    ...
    sens: "Débiteur ou Créditeur",
    contenu: "Ce compte enregistre les variations de stocks de biens et de marchandises achetés : entrées en stocks, sorties de stocks et différences entre inventaire comptable permanent et inventaire physique.",
    subdivisions: {
  ...
  "61": {
    ...
    nature: "Compte de gestion (Charges)",
    sens: "Débiteur",
    contenu: "Les frais de transport comprennent le montant des charges de port ou transports engagés par l'entreprise à l'occasion des achats, des ventes, des déplacements de son personnel ou de l'expédition de plis.",
    subdivisions: {
  ...
  "63": {
    ...
    nature: "Compte de gestion (Charges)",
    sens: "Débiteur",
    contenu: "Ce compte enregistre, comme le compte 62, le montant des factures et rémunérations versées aux prestataires extérieurs, pour les services de nature financière, juridique, sociale et autres.",
    subdivisions: {
      "631":  "Frais bancaires",
  ...
  "64": {
    ...
    nature: "Compte de gestion (Charges)",
    sens: "Débiteur",
    contenu: "Ce compte enregistre le montant des charges correspondant à des versements obligatoires à l'État et aux collectivités publiques pour subvenir à des dépenses publiques, ou des versements institués pour le financement d'actions d'intérêt général.",
    subdivisions: {
  ...
  "66": {
    ...
    nature: "Compte de gestion (Charges)",
    sens: "Débiteur",
    contenu: "Ce compte enregistre l'ensemble des rémunérations du personnel (appointements, salaires, commissions, congés payés, primes, gratifications, indemnités diverses), les rémunérations de l'exploitant individuel, les charges sociales patronales et les avantages en nature.",
    subdivisions: {
  ...
  "67": {
    ...
    nature: "Compte de gestion (Charges)",
    sens: "Débiteur",
    contenu: "Ce compte enregistre l'ensemble des charges financières dues à différents tiers intervenant dans le financement de l'entreprise, à l'exclusion de la rémunération des capitaux propres et des services bancaires.",
    subdivisions: {
  ...
  "68": {
    ...
    sens: "Débiteur",
    contenu: "Ce compte enregistre, au titre de l'exercice, les dotations aux amortissements d'exploitation et à caractère financier, dans leur conception économique et comptable (et non fiscale).",
    subdivisions: {
  ...
  "70": {
    ...
    sens: "Créditeur",
    contenu: "Ce compte enregistre les ressources de l'entreprise provenant de la vente de marchandises, de travaux effectués et de services rendus à des tiers.",
    subdivisions: {
  ...
  "71": {
    ...
    nature: "Compte de gestion (Produits)",
    sens: "Créditeur",
    contenu: "Aides financières accordées par l'État, des collectivités publiques ou des tiers, destinées à compenser l'insuffisance du prix de vente administré ou à faire face à des charges d'exploitation.",
    subdivisions: {
  ...
  "73": {
    ...
    contenu: "Ce compte enregistre les variations de stocks de biens et services produits : entrées et sorties de stocks, différences entre inventaire comptable et physique à la clôture.",
    subdivisions: {
  ...
  "75": {
    ...
    nature: "Compte de gestion (Produits)",
    sens: "Créditeur",
    contenu: "Tous les produits divers qui ne proviennent pas directement de l'activité productrice ou commerciale, ni de l'activité financière ou des relations avec l'État, mais qui relèvent néanmoins des activités ordinaires de l'entreprise.",
    subdivisions: {
  ...
  "759": {
    ...
    nature: "Compte de gestion (Produits)",
    sens: "Créditeur",
    contenu: "Ce compte enregistre les annulations ou régularisations en baisse des provisions à court terme sur éléments de l'actif circulant et des risques provisionnés.",
    subdivisions: {
  ...
  "81": {
    ...
    sens: "Débiteur",
    contenu: "Ce compte sert à déterminer la valeur comptable nette des éléments de l'actif immobilisé cédés. Pour les biens non amortissables : valeur d'entrée sans déduction des éventuelles provisions. Pour les biens amortissables : valeur d'entrée brute diminuée du cumul des amortissements pratiqués jusqu'à la date de cession.",
    subdivisions: {
  ...
  "82": {
    ...
    sens: "Créditeur",
    contenu: "Ce compte enregistre le produit net de la cession : prix résultant de l'accord entre les parties diminué des commissions et frais de vente (en cas de vente) ; montant contractuel (en cas d'apport) ; etc.",
    subdivisions: {
  ...
  "83": {
    ...
    nature: "Compte de gestion (Charges H.A.O.)",
    sens: "Débiteur",
    contenu: "Charges qui ne sont pas liées à l'activité ordinaire de l'entreprise et qui, de ce fait, n'ont généralement pas de caractère récurrent. Elles comprennent des charges constatées et des charges provisionnées.",
    subdivisions: {
  ...
  "84": {
    ...
    nature: "Compte de gestion (Produits H.A.O.)",
    sens: "Créditeur",
    contenu: "Produits qui ne sont pas liés à l'activité ordinaire de l'entreprise et sont dépourvus de caractère récurrent. Ils comprennent des produits constatés, des reprises de charges provisionnées et des transferts de charges.",
    subdivisions: {
  ...
  "88": {
    ...
    nature: "Compte de gestion (Produits)",
    sens: "Créditeur",
    contenu: "Ce compte enregistre le montant des subventions allouées par l'État ou l'un de ses démembrements à l'entreprise pour lui permettre de compenser, en totalité ou partiellement, des pertes survenues dans des circonstances exceptionnelles.",
    subdivisions: {
      "881": "État",
  ...
  "89": {
    ...
    sens: "Débiteur",
    contenu: "Part de bénéfice affectée obligatoirement à l'État au titre de l'impôt sur le résultat.",
    subdivisions: {
  ...
  "9011": {
    ...
    sens: "Débiteur",
    contenu: "Le solde débiteur représente la partie non utilisée des crédits qu'une banque s'est engagée irrévocablement à accorder à l'entreprise, y compris les crédits documentaires import-export confirmés.",
    fonctionnement: {
  ...
  "9012": {
    ...
    nature: "Compte hors bilan (Engagement de financement obtenu)",
    sens: "Débiteur",
    contenu: "Partie non encore encaissée des emprunts contractés auprès de tiers autres que les établissements bancaires (filiales, sociétés mères notamment).",
    fonctionnement: {
  ...
  "9021": {
    ...
    sens: "Débiteur",
    contenu: "L'avaliseur prend l'engagement de payer au créancier, à l'échéance, tout ou partie du nominal d'une lettre de change, d'un billet à ordre ou d'un chèque, à la place du tiré ou souscripteur défaillant.",
    fonctionnement: {
  ...
  "9023": {
    ...
    nature: "Compte hors bilan (Engagement de garantie obtenu)",
    sens: "Débiteur",
    contenu: "Lorsque l'entreprise reçoit de son débiteur un immeuble en hypothèque, elle acquiert le droit de faire saisir et vendre l'immeuble et de se faire payer par préférence sur le prix de la vente.",
    fonctionnement: {
  ...
  "9028": {
    ...
    nature: "Compte hors bilan (Engagement de garantie obtenu)",
    sens: "Débiteur",
    contenu: "Comprend notamment le gage, le nantissement et l'antichrèse, ainsi que les promesses d'hypothèque, les chèques de caution reçus, les actions reçues en garantie de gestion et les effets transmis aux tiers par endossement de procuration.",
    fonctionnement: {
  ...
  "9031": {
    ...
    sens: "Débiteur",
    contenu: "Le fournisseur s'engage à livrer des marchandises et l'entreprise s'engage à en prendre livraison et à en payer le prix convenu à la date de livraison.",
    fonctionnement: {
  ...
  "9041": {
    ...
    sens: "Débiteur",
    contenu: "Convention d'abandon de créances assortie d'une clause de retour à meilleure fortune : la créance est éteinte sous condition résolutoire — si le débiteur retrouve des moyens financiers suffisants, sa dette originelle est rétablie.",
    fonctionnement: {
  ...
  "9061": {
    ...
    sens: "Créditeur",
    contenu: "Par l'aval, l'entreprise prend l'engagement de payer au bénéficiaire à l'échéance tout ou partie du nominal d'une lettre de change, d'un billet à ordre ou d'un chèque, à la place du tiré ou souscripteur éventuellement défaillant.",
    fonctionnement: {
  ...
  "9062": {
    ...
    nature: "Compte hors bilan (Engagement de garantie accordé)",
    sens: "Créditeur",
    contenu: "L'entreprise, en tant que caution, promet à un créancier de le payer si le débiteur de ce dernier n'exécute pas son obligation. Comprend également les lettres d'intention ou lettres de confort dans lesquelles l'entreprise s'engage sans équivoque.",
    fonctionnement: {
  ...
  "9063": {
    ...
    nature: "Compte hors bilan (Engagement de garantie accordé)",
    sens: "Créditeur",
    contenu: "Lorsque l'entreprise donne à son créancier un immeuble en hypothèque, ce créancier acquiert le droit de faire saisir et vendre l'immeuble et de se faire payer par préférence sur le prix de la vente.",
    fonctionnement: {
  ...
  "9068": {
    ...
    nature: "Compte hors bilan (Engagement de garantie accordé)",
    sens: "Créditeur",
    contenu: "Comprend notamment le gage, le nantissement et l'antichrèse, ainsi que les promesses d'hypothèque et les effets reçus des tiers par endossement de procuration.",
    fonctionnement: {
  ...
  "9071": {
    ...
    sens: "Créditeur",
    contenu: "L'entreprise s'engage à livrer des marchandises et son client s'engage à en prendre livraison et à en payer le prix à la date de livraison.",
    fonctionnement: {
  ...
  "9073": {
    ...
    nature: "Compte hors bilan (Engagement réciproque accordé)",
    sens: "Créditeur",
    contenu: "L'entreprise s'engage de façon irrévocable à payer le prix des travaux exécutés pour son compte conformément aux spécifications de sa commande.",
    fonctionnement: {
  ...
  "9081": {
    ...
    sens: "Créditeur",
    contenu: "Convention d'annulation de dettes assortie d'une clause de retour à meilleure fortune : la dette de l'entreprise est éteinte sous condition résolutoire — si elle retrouve des moyens financiers suffisants, sa dette originelle est rétablie.",
    fonctionnement: {
  ...
  "9082": {
    ...
    nature: "Compte hors bilan (Autre engagement accordé)",
    sens: "Créditeur",
    contenu: "Sommes que l'entreprise s'est engagée à verser à ses salariés et/ou dirigeants lors de leur départ à la retraite (indemnités de départ ou complément de pension), pour la part non inscrite au bilan en dettes provisionnées.",
    fonctionnement: {
